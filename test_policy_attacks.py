...
# ============================================================
# v0.2 POLICY BYPASS ATTACK TESTS
# ============================================================


def test_extra_arguments_do_not_bypass_policy():
    fw = Firewall()
...
def test_nested_argument_does_not_match_flat_argument():
    fw = Firewall()
...
def test_case_changed_argument_does_not_match():
    fw = Firewall()
