...
EXPECTED_INVARIANTS = frozenset(
    {
        ...
        # v3.1 -- AUTHORIZED =/= EXECUTED =/= OBSERVED =/= VERIFIED =/=
        # ATTESTED =/= COMPLETED: attestation is a distinct, externally
        # sourced stage, bound to the exact effect/attempt/correlation it
        # speaks about, only reachable through a verified signature from a
